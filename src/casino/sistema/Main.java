...
public class Main {
    public static void main(String[] args) throws IOException, JuegoInactivoException, SaldoInsuficienteException,
            ApuestaMaximaInvalidaException, JuegoInactivoRuletaException {
            ...
            do {
                ...
                switch (opcion) {
                    case 1: // Registrar Jugador
                        ...
                        while (!registroexitoso) {
                            try {
                                ...
                                String apeJ = sc.nextLine();
                                System.out.println("Edad: ");
                                int edadJ = sc.nextInt();
                                sc.nextLine();
                                System.out.println("ID jugador (ej. JUG-001): ");
                                String id = sc.nextLine();
                                System.out.println("Saldo con el que inicia: ");
                    ...
                    case 2: // Registrar Jugador VIP
                        ...
                        while (!registroexitosovip) {
                            try {
                                ...
                                System.out.println("Apellido: ");
                                String apeV = sc.nextLine();
                                System.out.println("Edad: ");
                                int edadV = sc.nextInt();
                                sc.nextLine();
                                System.out.println("Nivel VIP (Bronce, Plata, Oro): ");
                                String nivelVIP = sc.nextLine();
                                System.out.println("ID jugador (ej. JUG-VIP1): ");
                                String idV = sc.nextLine();
                                System.out.println("Saldo con el que inicia: ");
                                double saldoV = sc.nextDouble();
                                sc.nextLine();

                                JugadorVIP nuevoVIP = new JugadorVIP(nomV, apeV, edadV, saldoV, idV, nivelVIP, 1000.0,
                                        10.0);
                    ...
                    case 3: // Registrar Empleado
                        ...
                        while (!registroExitosoEmp) {
                            try {
                                ...
                                sc.nextLine();
                                System.out.println("Cédula (ej. EMP-001): ");
                                String cedE = sc.nextLine();
                    ...
                    case 4: // Buscar jugador
                        System.out.println("ID que desea buscar");
                        String jugbuscar = sc.nextLine();
                        try {
                    ...
                    case 5: // Jugar a la ruleta
                        System.out.println("\n==== RULETA ====\n");
                        System.out.println("Ingresar el ID del jugador: ");
                        String idruleta = sc.nextLine();
                        ...
                        try {
                            ...
                            System.out.println("Escriba el monto que desea apostar: (mínimo $"
                                    + mesaRuleta.getApuestaMinima() + ")");
                            double montapuesta = sc.nextDouble();
                            sc.nextLine();
                            System.out.println("Número en el que desea apostar (0-36): ");
                            int numero = sc.nextInt();
                            sc.nextLine();
                            System.out.println("Color (Rojo, Negro, Verde): ");
                    ...
                    case 6: // Jugar a BlackJack
                        ...
                        try {
                            ...
                            System.out.println(
                                    "Escriba el monto que desea apostar: (mínimo $" + mesaBJ.getApuestaMinima() + ")");
                            double montoBJ = sc.nextDouble();
                            sc.nextLine();
                            mesaBJ.prepararApuesta(montoBJ);
                            mesaBJ.jugar();
                            jugadorService.actualizarJugador();
                        } catch (ApuestaMinimaInvalidaException | SaldoInsuficienteException | IllegalArgumentException
                                | IOException e) {
                            System.out.println("Algo está fallando en la partida: " + e.getMessage());
                        }
                        break;
                    ...
                    case 8: // Eliminar jugador
                        System.out.println("Ingresa el ID del jugador para eliminar: ");
                        String idbyebye = sc.nextLine();
                        jugadorService.eliminarJugador(idbyebye);
                        System.out.println("El ha sido eliminado exitosamente!!!");
                        break;

                    case 9: // Eliminar empleado
                        System.out.println("Cédula de empleado para elmininar: ");
                        String ceeliminar = sc.nextLine();
